    ...
    <div class="max-w-3xl mx-auto">
        <div
            ...
            <div class="p-6 faq">
                ...
                <h1 href="#" class="text-gray-900 font-bold text-4xl">Frequent Asked Question (FAQ)</h1>
                <div class="py-5 text-sm font-regular text-gray-900 flex">
                    <span class="ml-1">Berikut adalah list pertanyaan yang sering ditanyakan</span></a>
                </div>
                <hr>
