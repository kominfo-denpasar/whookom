...
return [
    ...
    */
    ...
    'buttons' => [
        ...
        'edit'                          => '<span class="hidden-xs hidden-sm">Edit </span><i class="fa fa-wrench fa-fw" aria-hidden="true"></i>',
        'edit-larger'                   => 'Edit <i class="fa fa-wrench fa-fw" aria-hidden="true"></i>',
        'delete'                        => '<span class="hidden-xs hidden-sm">Delete </span><i class="fa fa-trash fa-fw" aria-hidden="true"></i>',
        'delete-large'                  => 'Delete <i class="fa fa-trash fa-fw" aria-hidden="true"></i>',
